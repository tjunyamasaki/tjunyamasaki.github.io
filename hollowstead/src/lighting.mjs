...
import {EQUIPMENT, RULES, STRUCTURES} from './content.mjs?v=harvest-12';
import {RANGES} from './contracts.mjs?v=harvest-12';
import {equippedLanternLit} from './inventory.mjs?v=harvest-12';
