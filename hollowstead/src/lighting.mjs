...
import {EQUIPMENT, RULES, STRUCTURES} from './content.mjs?v=harvest-15';
import {RANGES} from './contracts.mjs?v=harvest-15';
import {equippedLanternLit} from './inventory.mjs?v=harvest-15';
