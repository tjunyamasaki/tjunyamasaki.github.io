...
import {EQUIPMENT, ITEMS, label} from '../content.mjs?v=harvest-14';
import {magicItems} from '../magic/registry.mjs?v=harvest-14';
import {contextActionIds, dismantleRule} from '../interactions.mjs?v=harvest-14';
