...
import { move } from "../tableState.js";
...
function applyPresidentAction(ctx, actorId, intent) {
  if (intent.action === "sendCards" || intent.action === "sendCards") {
    ...
    const ids = intent.cardIds || intent.elementIds || (intent.cardId ? [intent.cardId] : []);
